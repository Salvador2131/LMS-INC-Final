...
const CourseDetail = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      const mockCourse = {
        ...
        description:
          "Este curso cubre temas avanzados de matemáticas incluyendo cálculo diferencial e integral, ecuaciones diferenciales y análisis numérico. Está diseñado para estudiantes con conocimientos previos de álgebra y trigonometría.",
        objectives: [
        ...
        modules: [
          {
            ...
            lessons: [
              ...
              {
                id: "l2",
                title: "Derivadas: concepto y cálculo",
                completed: true,
              },
              {
                id: "l3",
          ...
          },
          {
            ...
            lessons: [
              ...
              {
                id: "l8",
                title: "Ecuaciones diferenciales de segundo orden",
                completed: false,
              },
              {
                id: "l9",
                title: "Aplicaciones en física e ingeniería",
                completed: false,
              },
            ],
          },
  ...
  const completedLessons = course.modules.reduce(
    (count: number, module: any) =>
      count + module.lessons.filter((l: any) => l.completed).length,
    0
  );
      ...
      <Tabs defaultValue="content">
        ...
        <TabsContent value="tareas">
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="space-y-6">
              {course.tareas.map((tarea: any) => (
                <Card key={tarea.id}>
                  <CardContent className="p-6">
                    <div className="flex flex-col md:flex-row justify-between">
                      <div>
                        <h3 className="font-medium text-lg">{tarea.title}</h3>
                        <p className="text-sm text-muted-foreground mt-1">
                          Fecha de entrega: {tarea.dueDate}
                        </p>
                      </div>
